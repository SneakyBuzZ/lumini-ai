...
const Navbar = () => {
  ...
  return (
    <nav className="absolute z-30 top-0 w-full h-[56px] flex justify-between items-center bg-midnight-400/80 backdrop-blur-md px-10 border-dashed border-b border-neutral-800">
      <div className="w-full h-full flex justify-between items-center border-dashed border-x border-neutral-800 px-8">
